...
module.exports = app => {
  ...
  router.post('/travels/:travelId/accept', validateToken, TravelController.patchTravelState('accept'), handlerResponse);
  router.post('/travels/:travelId/reject', validateToken, TravelController.patchTravelState('reject'), handlerResponse);
  router.post('/travels/:travelId/start', validateToken, TravelController.patchTravelState('start'), handlerResponse);
  router.post('/travels/:travelId/finish', validateToken, TravelController.patchTravelState('finish'), handlerResponse);
